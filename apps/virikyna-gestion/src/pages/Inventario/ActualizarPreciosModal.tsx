...
export function ActualizarPreciosModal({ productos, proveedores, seleccionInicial, onClose, onSaved }: Props) {
  ...
  return (
    <Modal title="Actualización masiva de precios" onClose={pedirCierre} widthClassName="max-w-[560px]">
