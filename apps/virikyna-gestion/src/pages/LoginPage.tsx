    ...
    <div className="flex h-screen flex-col bg-bg">
      <div className="flex flex-1 items-center justify-center">
        <form onSubmit={handleSubmit} className="w-full max-w-[420px] rounded-lg bg-surface p-card shadow-sm">
          <h1 className="font-display text-headline-lg text-accent-darker">Virikyna Gestión</h1>
          <p className="mt-1 font-sans text-body-md text-ink-soft">Acceso exclusivo para administradoras.</p>
