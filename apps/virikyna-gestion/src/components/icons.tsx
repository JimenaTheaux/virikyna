...
export function IconCajaGestion({ className, filled }: IconProps) {
  return (
    <svg {...iconAttrs(filled)} className={className}>
...
export function IconEgresos({ className, filled }: IconProps) {
  return (
    <svg {...iconAttrs(filled)} className={className}>
      <path d="M19 5 5 19" />
      <path d="M19 5v8.5" />
...
export function IconHistorial({ className, filled }: IconProps) {
  return (
    <svg {...iconAttrs(filled)} className={className}>
