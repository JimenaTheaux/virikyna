...
// Mismos tokens que apps/virikyna-local y apps/virikyna-inventario, tomados 1:1 de
// docs/08_estilos_y_diseno.md — una sola identidad visual entre las tres apps de Virikyna.
export default {
